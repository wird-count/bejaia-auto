...
const dealership = {
  ...
  phone: "0799533364",
  phone2: "0797984797",
  phoneIntl: "+213799533364",
  phone2Intl: "+213797984797",
  whatsapp: "213799533364",
  whatsapp2: "213797984797",
  email: "mazighsgh@gmail.com",
  address: "Béjaïa, zone industrielle, 06000, Algérie",
  hours: "Toujours ouvert",
  city: "Béjaïa",
  country: "Algérie",
  mapQuery: "Béjaïa Auto, zone industrielle, Béjaïa, Algérie",
  instagram: "https://www.instagram.com/Bejaia.auto",
  facebook: "https://www.facebook.com/share/1Dit4SBgxH/?mibextid=wwXIfr"
};
...
const VEHICLES = [
  ...
  },
  {
    ...
    price: null,
    availability: "available",
    image: "images/audi-s3.jpg",
    alt: "Audi S3 — Groupe Alpha Auto"
  },
  {
    brand: "Volkswagen",
    ...
    alt: "Volkswagen Golf 8.5 Full Option — Groupe Alpha Auto"
  },
  {
    brand: "Volkswagen",
    model: "Tharu XR",
    ...
    price: null,
    availability: "available",
    image: "images/tharu-xr.jpg",
    alt: "Volkswagen Tharu XR — Groupe Alpha Auto"
  },
  {
    brand: "Volkswagen",
    model: "Tiguan",
    ...
    alt: "Volkswagen Tiguan — Groupe Alpha Auto"
  },
  {
    brand: "Volkswagen",
    model: "T-Roc",
    ...
    alt: "Volkswagen T-Roc — Groupe Alpha Auto"
  },
  {
    brand: "Jetta",
    model: "VS5",
    ...
    alt: "Jetta VS5 — Groupe Alpha Auto"
  },
  {
    brand: "Kia",
    model: "Seltos",
    ...
    alt: "Kia Seltos — Groupe Alpha Auto"
  },
  {
    brand: "Kia",
    model: "KX1",
    ...
    price: null,
    availability: "available",
    image: "images/kia-kx1.jpg",
    alt: "Kia KX1 — Groupe Alpha Auto"
  },
  {
    brand: "MG",
    model: "MG5",
  ...
  },
  {
    ...
    alt: "Hyundai Elantra — Groupe Alpha Auto"
  },
  {
    brand: "Geely",
    ...
    alt: "Geely Coolray Full Option — Groupe Alpha Auto"
  },
  {
    brand: "Livan",
    model: "X3 Pro",
    ...
    alt: "Livan X3 Pro — Groupe Alpha Auto"
  },
  {
    brand: "Jetour",
    model: "Jetour",
  ...
  },
  {
    ...
    availability: "order",
    image: null,
    alt: "Autres véhicules disponibles sur commande — Groupe Alpha Auto"
  }
];
...
const REVIEWS = [
  {
    name: "Karim B.",
    text: "Excellent service, véhicule neuf livré dans les délais. Je recommande vivement Béjaïa Auto.",
    rating: 5
  },
  {
    name: "Amel M.",
    text: "J'ai acheté une Golf 8.5, très bon rapport qualité-prix. L'équipe est professionnelle et à l'écoute.",
    rating: 5
  },
  {
    name: "Sofiane T.",
    text: "Importation rapide et sans souci, accompagnement complet. Merci !",
    rating: 5
  }
];
...
function renderVehicles() {
  ...
  const list = activeBrand === "all"
    ? uniqueSaleBrands().map(b => VEHICLES.find(v => v.brand === b))
  ...
  grid.innerHTML = list.map((v, i) => {
    const media = v.image
      ...
      : `<div style="position:absolute;inset:0;display:grid;place-items:center;color:#9a9aa0;font-weight:700;padding:1rem;text-align:center;background:#1d1d20;">${v.brand} ${v.model}</div>`;
...
const emailIcon = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/></svg>';
...
function renderContact() {
  ...
  grid.innerHTML =
    ...
    contactCard(emailIcon, "Email", dealership.email, `mailto:${dealership.email}`);
}
...
/* Numéros WhatsApp pour les véhicules */
const VEHICLE_WA_NUMBERS = [
  { label: "WhatsApp 1", display: formatPhone(dealership.phone), wa: "213799533364" },
  { label: "WhatsApp 2", display: formatPhone(dealership.phone2), wa: "213797984797" }
];
